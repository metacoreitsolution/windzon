...
$baseUrl = '../';
$activePage = 'terms';
$pageTitle = 'Terms & Conditions - Windzon';
$pageDescription = 'Windzon terms and conditions for aluminium window and door services.';
$pageKeywords = 'terms and conditions, service terms, Windzon terms';
$additionalCSS = [];
$additionalJS = [];
