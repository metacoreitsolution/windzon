...
$baseUrl = '../';
$activePage = 'faq';
$pageTitle = 'FAQ - Windzon';
$pageDescription = 'Frequently asked questions about Windzon aluminium windows and doors. Find answers about installation, pricing, warranty, and more.';
$pageKeywords = 'Windzon FAQ, window questions, door questions, installation FAQ';
$additionalCSS = [];
$additionalJS = [];
