...
<head>
    ...
    <meta name="description" content="Learn about Windzon – 32+ years of aluminium windows and doors expertise. Quality, precision, and customer commitment for residential and commercial projects.">
    <meta name="keywords" content="about Windzon, aluminium company, windows doors manufacturer">
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        ...
                        <div class="nav-right">
                            <div class="nav-right-btn mt-2">
                                <a href="contact.php" class="theme-btn">Get A Quote<i
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-left wow fadeInLeft" data-wow-delay=".25s">
                            <div class="about-img">
                                <img src="assets/img/about/01.jpg" alt="About Our Aluminium Company">
                            </div>
                            <div class="about-experience">
                                <div class="about-experience-icon">
                                    <img src="assets/img/icon/window.svg" alt="Aluminium Icon">
                                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="choose-img wow fadeInLeft" data-wow-delay=".25s">
                            <img src="assets/img/choose/01.jpg" alt="Why Choose Our Aluminium Company">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="choose-content wow fadeInRight" data-wow-delay=".25s">
                            ...
                            <div class="choose-wrapper mt-4">
                                ...
                                <div class="choose-item">
                                    <div class="choose-icon">
                                        <img src="assets/img/icon/accessory.svg" alt="">
                                    </div>
                                    <div class="choose-item-content">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="quality-img wow fadeInRight" data-wow-delay=".25s">
                            <img src="assets/img/about/02.jpg" alt="Aluminium Quality Standards">
                        </div>
                    </div>
                ...
                <div class="cta-wrapper" style="background-image: url(assets/img/cta/01.jpg);">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 text-center text-lg-end">
                            <a href="testimonial.php" class="theme-btn theme-btn2">View All Testimonials<i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
