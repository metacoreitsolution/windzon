...
<head>
    ...
    <meta name="description" content="Windzon services: aluminium window & door installation, maintenance, repair, accessories, project planning. Professional solutions for homes and businesses.">
    <meta name="keywords" content="window installation, door repair, aluminium maintenance, Windzon services">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item wow fadeInDown" data-wow-delay=".25s">
                            <div class="service-img">
                                ...
                                <div class="service-icon">
                                    <img src="assets/img/icon/window-2.svg" alt="">
                                </div>
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="service-img">
                                ...
                                <div class="service-icon">
                                    <img src="assets/img/icon/window-3.svg" alt="">
                                </div>
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                ...
                <div class="row footer-widget-wrapper pt-100 pb-70">
                    <div class="col-md-6 col-lg-4">
                        <div class="footer-widget-box about-us">
                            ...
                            <p class="mb-3">
                                Windzon provides premium aluminium windows and doors with 32+ years of expertise. Quality materials, expert installation, and dedicated support for every project.
                            </p>
