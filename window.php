...
<head>
    ...
    <meta name="description" content="Explore Windzon's premium aluminium windows – casement, sliding, fixed, top-hung, bay & bow, sash. Energy-efficient, durable, and stylish for homes and offices.">
    <meta name="keywords" content="aluminium windows, casement windows, sliding windows, window installation">
                ...
                <div class="container custom-nav position-relative">
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="window.php">Windows</a></li>
