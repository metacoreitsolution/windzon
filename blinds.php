...
<head>
    ...
    <meta name="description" content="Windzon premium window blinds – stylish, functional solutions for homes and offices. Complement your aluminium windows with quality blinds.">
    <meta name="keywords" content="window blinds, aluminium blinds, Windzon blinds">

    <!-- title -->
    <title>Windzon - Blinds And Doors Service </title>
                ...
                <div class="container custom-nav position-relative">
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="blinds.php">Blinds</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="feature-item wow fadeInUp" data-wow-delay=".25s">
                                <div class="feature-icon">
                                    <img src="assets/img/icon/sound.svg" alt="Light Control">
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="feature-item wow fadeInDown" data-wow-delay=".25s">
                                <div class="feature-icon">
                                    <img src="assets/img/icon/door-lock.svg" alt="Privacy">
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="feature-item wow fadeInUp" data-wow-delay=".25s">
                                <div class="feature-icon">
                                    <img src="assets/img/icon/weather.svg" alt="Easy Operation">
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="feature-item wow fadeInDown" data-wow-delay=".25s">
                                <div class="feature-icon">
                                    <img src="assets/img/icon/money.svg" alt="Low Maintenance">
                                </div>
