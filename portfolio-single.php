...
<body>
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="portfolio-details">
                                <div class="portfolio-details-img mb-30">
                                    <img id="portfolio-main-img" src="assets/img/portfolio/single.jpg" alt="thumb">
                                </div>
                                <div class="portfolio-details">
    ...
    (function() {
        var projects = {
            showroom: {
                name: 'Luxury Aluminium Showroom',
                category: 'Showroom',
                img: 'assets/img/portfolio/01.jpg',
                date: '12 Jan, 2025',
                client: 'Windzon Display Ltd',
                budget: '$45,000',
            ...
            cafe: {
                ...
                category: 'Cafes',
                img: 'assets/img/portfolio/05.jpg',
                date: '05 May, 2025',
            ...
            commercial: {
                ...
                category: 'Commercial',
                img: 'assets/img/portfolio/06.jpg',
                date: '18 Jun, 2025',
        ...
        var defaultProject = {
            ...
            category: 'Modern Window',
            img: 'assets/img/portfolio/single.jpg',
            date: '14 March, 2025',
            client: 'Roger M Collins',
            budget: '$1250.00',
            manager: 'Doseph Brehmer',
            location: 'New York, USA',
            content: document.getElementById('portfolio-content-body').innerHTML
        };
        var params = new URLSearchParams(window.location.search);
        var projectId = params.get('project') || '';
        var project = projects[projectId] || defaultProject;
        document.getElementById('portfolio-breadcrumb-title').textContent = project.name;
        document.getElementById('portfolio-breadcrumb-current').textContent = project.name;
        document.getElementById('portfolio-main-img').src = project.img;
        document.getElementById('portfolio-main-img').alt = project.name;
        document.getElementById('portfolio-main-title').textContent = project.name;
        ...
        document.getElementById('portfolio-budget').textContent = project.budget;
        document.getElementById('portfolio-manager').textContent = project.manager;
        document.getElementById('portfolio-location').textContent = project.location;
        document.getElementById('portfolio-content-body').innerHTML = project.content;
        document.title = project.name + ' - Windzon';
    })();
    </script>
